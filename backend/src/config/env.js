...
export const env = {
  ...
  ai: {
    text: {
      provider: process.env.AI_TEXT_PROVIDER || 'puter',
      baseUrl: process.env.AI_TEXT_BASE_URL || '',
      apiKey: process.env.AI_TEXT_API_KEY || '',
      model: process.env.AI_TEXT_MODEL || 'gpt-5.4-nano',
    },
    image: {
      provider: process.env.AI_IMAGE_PROVIDER || 'puter',
      baseUrl: process.env.AI_IMAGE_BASE_URL || '',
      apiKey: process.env.AI_IMAGE_API_KEY || '',
      model: process.env.AI_IMAGE_MODEL || 'flux',
      size: process.env.AI_IMAGE_SIZE || '1024x1024',
    },
    design: {
      provider: process.env.AI_DESIGN_PROVIDER || 'puter',
      baseUrl: process.env.AI_DESIGN_BASE_URL || '',
      apiKey: process.env.AI_DESIGN_API_KEY || '',
      model: process.env.AI_DESIGN_MODEL || 'gpt-5.4-nano',
    },
    vision: {
      provider: process.env.AI_VISION_PROVIDER || process.env.AI_DESIGN_PROVIDER || 'puter',
      baseUrl: process.env.AI_VISION_BASE_URL || process.env.AI_DESIGN_BASE_URL || '',
      apiKey: process.env.AI_VISION_API_KEY || process.env.AI_DESIGN_API_KEY || '',
      model: process.env.AI_VISION_MODEL || process.env.AI_DESIGN_MODEL || 'gemini-3.6-flash',
    },
    puter: {
    ...
    gemini: {
      ...
      baseUrl: process.env.AI_GEMINI_BASE_URL || 'https://generativelanguage.googleapis.com/v1beta/openai',
      textModel: process.env.AI_GEMINI_TEXT_MODEL || 'gemini-3.5-flash',
      designModel: process.env.AI_GEMINI_DESIGN_MODEL || 'gemini-3.5-flash',
      visionModel: process.env.AI_GEMINI_VISION_MODEL || 'gemini-3.5-flash',
    },
    groq: {
      apiKey: process.env.AI_GROQ_API_KEY || '',
      baseUrl: process.env.AI_GROQ_BASE_URL || 'https://api.groq.com/openai/v1',
      textModel: process.env.AI_GROQ_TEXT_MODEL || 'llama-3.3-70b-versatile',
      designModel: process.env.AI_GROQ_DESIGN_MODEL || 'llama-3.3-70b-versatile',
      visionModel: process.env.AI_GROQ_VISION_MODEL || 'llama-3.2-90b-vision-preview',
    },
  },
